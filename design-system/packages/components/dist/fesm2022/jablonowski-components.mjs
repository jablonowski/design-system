...
class DsFeatureCardComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.20", type: DsFeatureCardComponent, isStandalone: true, selector: "ds-feature-card", inputs: { icon: "icon", heading: "heading", description: "description", linkText: "linkText" }, ngImport: i0, template: "<mat-card class=\"feature-card\" appearance=\"outlined\">\n  <mat-card-content>\n    @if (icon) {\n      <div class=\"icon-wrapper\">\n        <mat-icon>{{ icon }}</mat-icon>\n      </div>\n    }\n    <h3 class=\"card-heading\">{{ heading }}</h3>\n    <p class=\"card-description\">{{ description }}</p>\n    @if (linkText) {\n      <a class=\"card-link\">{{ linkText }} \u2192</a>\n    }\n  </mat-card-content>\n</mat-card>\n", styles: [":host{display:block}.feature-card{font-family:var(--ds-typography-font-family-base, \"Roboto\", sans-serif);border-radius:var(--ds-border-radius-md, 8px);border-left:4px solid var(--ds-color-neutral-300, #e0e0e0);transition:box-shadow .2s ease,transform .2s ease,border-color .2s ease;height:100%;cursor:default}.feature-card:hover{border-left-color:var(--ds-color-primary-base, #003b7e);box-shadow:var(--ds-elevation-md, 0 4px 12px rgba(0, 0, 0, .15));transform:translateY(-2px)}.icon-wrapper{display:flex;align-items:center;justify-content:center;width:56px;height:56px;border-radius:50%;background-color:var(--ds-color-primary-light, #e3f2fd);margin-bottom:1rem}.icon-wrapper mat-icon{font-size:28px;width:28px;height:28px;color:var(--ds-color-primary-base, #003b7e)}.card-heading{font-size:var(--ds-typography-font-size-lg, 1.125rem);font-weight:var(--ds-typography-font-weight-semibold, 600);color:var(--ds-color-text-primary, #212121);margin:0 0 .5rem}.card-description{font-size:var(--ds-typography-font-size-sm, .875rem);color:var(--ds-color-text-secondary, #616161);line-height:1.6;margin:0 0 1rem}.card-link{display:inline-block;font-size:var(--ds-typography-font-size-sm, .875rem);font-weight:var(--ds-typography-font-weight-medium, 500);color:var(--ds-color-primary-base, #003b7e);text-decoration:none;cursor:pointer}.card-link:hover{text-decoration:underline}\n"], dependencies: [{ kind: "ngmodule", type: MatCardModule }, { kind: "component", type: i1$2.MatCard, selector: "mat-card", inputs: ["appearance"], exportAs: ["matCard"] }, { kind: "directive", type: i1$2.MatCardContent, selector: "mat-card-content" }, { kind: "ngmodule", type: MatIconModule }, { kind: "component", type: i2.MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }, { kind: "ngmodule", type: MatButtonModule }] });
}
...
class DsFooterComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.20", type: DsFooterComponent, isStandalone: true, selector: "ds-footer", inputs: { companyName: "companyName", year: "year" }, ngImport: i0, template: "<footer>\n  <div class=\"footer-top\">\n    <ng-content select=\"[footerLinks]\"></ng-content>\n  </div>\n  <mat-divider></mat-divider>\n  <div class=\"footer-bottom\">\n    <span class=\"copyright\">&copy; {{ year }} {{ companyName }}</span>\n    <div class=\"social\">\n      <ng-content select=\"[footerSocial]\"></ng-content>\n    </div>\n  </div>\n</footer>\n", styles: [":host{display:block}footer{font-family:var(--ds-typography-font-family-base, \"Roboto\", sans-serif);background-color:var(--ds-color-neutral-900, #1a1a2e);color:var(--ds-color-neutral-300, #bdbdbd);padding:2.5rem 2rem 1.5rem}.footer-top{display:grid;grid-template-columns:repeat(4,1fr);gap:2rem;margin-bottom:2rem}.footer-top ::ng-deep>*{display:contents}.footer-top ::ng-deep h4{color:#fff;font-size:var(--ds-typography-font-size-sm, .875rem);font-weight:var(--ds-typography-font-weight-semibold, 600);text-transform:uppercase;letter-spacing:.05em;margin:0 0 1rem}.footer-top ::ng-deep ul{list-style:none;padding:0;margin:0}.footer-top ::ng-deep ul li{margin-bottom:.5rem}.footer-top ::ng-deep ul a{color:var(--ds-color-neutral-400, #9e9e9e);text-decoration:none;font-size:var(--ds-typography-font-size-sm, .875rem);transition:color .15s}.footer-top ::ng-deep ul a:hover{color:#fff}mat-divider{border-top-color:#ffffff1f}.footer-bottom{display:flex;justify-content:space-between;align-items:center;padding-top:1.5rem;flex-wrap:wrap;gap:1rem}.copyright{font-size:var(--ds-typography-font-size-sm, .875rem)}.social{display:flex;gap:2rem}.social ::ng-deep>*{display:contents}.social ::ng-deep a,.social ::ng-deep button{color:var(--ds-color-neutral-400, #9e9e9e);transition:color .15s}.social ::ng-deep a:hover,.social ::ng-deep button:hover{color:#fff}@media(max-width:600px){.footer-bottom{flex-direction:column;text-align:center}}\n"], dependencies: [{ kind: "ngmodule", type: MatIconModule }, { kind: "ngmodule", type: MatButtonModule }, { kind: "ngmodule", type: MatDividerModule }, { kind: "component", type: i1$3.MatDivider, selector: "mat-divider", inputs: ["vertical", "inset"] }] });
}
